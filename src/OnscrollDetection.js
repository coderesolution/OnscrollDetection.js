			...
			gsap.utils.toArray( this.elements ).forEach( ( oElement, iIndex ) => {
				...
				if ( oElement.hasAttribute( 'data-onscroll-debug' ) ) {
					...
					console.log( {
						...
						offset: iOffset,
						distance: iDistance,
						speed: ( oElement.hasAttribute( 'data-onscroll-speed' ) ? oElement.dataset.onscrollSpeed + ' calculated at ' + ( 1 - parseFloat( oElement.dataset.onscrollSpeed ) ) * ( ScrollTrigger.maxScroll( window ) - ( this.scrollTrigger ? this.scrollTrigger.start : 0 ) ) : null ),
