...
| `data-onscroll-reverse`   |         |         Not set         | Reverse the direction when combined with `data-onscroll-offset` or `data-onscroll-auto`. Note this has no effect on the speed setting.                                                                                                                                                                                                                                                                                                                                                 |
